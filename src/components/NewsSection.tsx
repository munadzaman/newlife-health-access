...
const NewsSection = () => {
  const newsItems = [
    ...
    },
    {
      ...
      excerpt: "Our rural outreach program has successfully provided free cataract surgeries to over 500 patients across Bangladesh.",
      date: "2024-01-10",
      readTime: "4 min read",
    ...
    },
    {
      ...
      excerpt: "Our new partnership with Bangladesh Health Development Initiative will bring comprehensive eye care services to remote villages.",
      date: "2024-01-05",
      readTime: "2 min read",
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-green-50 to-blue-50" id="news">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {newsItems.map((news) => (
            <Card key={news.id} className="hover:shadow-lg transition-shadow duration-300 overflow-hidden bg-white">
              <div className="flex md:flex-col">
                <div className="relative h-32 md:h-48 w-32 md:w-full flex-shrink-0">
                  <img 
                    src={news.image} 
                    alt={news.title}
